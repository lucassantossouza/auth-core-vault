...
/***/ "./libs/auth-vault/src/auth-vault.module.ts"
/*!**************************************************!*\
  !*** ./libs/auth-vault/src/auth-vault.module.ts ***!
  \**************************************************/
...
const tokens_1 = __webpack_require__(/*! ./tokens */ "./libs/auth-vault/src/tokens/index.ts");
const auth_vault_service_1 = __webpack_require__(/*! ./auth-vault.service */ "./libs/auth-vault/src/auth-vault.service.ts");
const constants_1 = __webpack_require__(/*! ./constants */ "./libs/auth-vault/src/constants/index.ts");
const auth_vault_providers_1 = __webpack_require__(/*! ./auth-vault.providers */ "./libs/auth-vault/src/auth-vault.providers.ts");
...
/***/ "./libs/auth-vault/src/auth-vault.providers.ts"
/*!*****************************************************!*\
  !*** ./libs/auth-vault/src/auth-vault.providers.ts ***!
  \*****************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const auth_guard_const_1 = __webpack_require__(/*! ./constants/auth-guard.const */ "./libs/auth-vault/src/constants/auth-guard.const.ts");
const tokens_1 = __webpack_require__(/*! ./tokens */ "./libs/auth-vault/src/tokens/index.ts");
const strategies_registry_1 = __webpack_require__(/*! ./strategies/strategies.registry */ "./libs/auth-vault/src/strategies/strategies.registry.ts");
const constants_1 = __webpack_require__(/*! ./constants */ "./libs/auth-vault/src/constants/index.ts");
const auth_vault_logger_factory_const_1 = __webpack_require__(/*! ./constants/auth-vault-logger-factory.const */ "./libs/auth-vault/src/constants/auth-vault-logger-factory.const.ts");
const auth_vault_logger_1 = __webpack_require__(/*! ./logger/auth-vault.logger */ "./libs/auth-vault/src/logger/auth-vault.logger.ts");
const auth_vault_service_1 = __webpack_require__(/*! ./auth-vault.service */ "./libs/auth-vault/src/auth-vault.service.ts");
const guards_1 = __webpack_require__(/*! ./guards */ "./libs/auth-vault/src/guards/index.ts");
...
/***/ "./libs/auth-vault/src/auth-vault.service.ts"
/*!***************************************************!*\
  !*** ./libs/auth-vault/src/auth-vault.service.ts ***!
  \***************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const auth_strategies_token_1 = __webpack_require__(/*! ./tokens/auth-strategies.token */ "./libs/auth-vault/src/tokens/auth-strategies.token.ts");
const tokens_1 = __webpack_require__(/*! ./tokens */ "./libs/auth-vault/src/tokens/index.ts");
const auth_vault_logger_factory_const_1 = __webpack_require__(/*! ./constants/auth-vault-logger-factory.const */ "./libs/auth-vault/src/constants/auth-vault-logger-factory.const.ts");
...
/***/ "./libs/auth-vault/src/constants/auth-guard.const.ts"
/*!***********************************************************!*\
  !*** ./libs/auth-vault/src/constants/auth-guard.const.ts ***!
  \***********************************************************/
...
/***/ "./libs/auth-vault/src/constants/auth-messages.const.ts"
/*!**************************************************************!*\
  !*** ./libs/auth-vault/src/constants/auth-messages.const.ts ***!
  \**************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/constants/auth-metadata.const.ts"
/*!**************************************************************!*\
  !*** ./libs/auth-vault/src/constants/auth-metadata.const.ts ***!
  \**************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/constants/auth-method-header.const.ts"
/*!*******************************************************************!*\
  !*** ./libs/auth-vault/src/constants/auth-method-header.const.ts ***!
  \*******************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/constants/auth-vault-logger-factory.const.ts"
/*!**************************************************************************!*\
  !*** ./libs/auth-vault/src/constants/auth-vault-logger-factory.const.ts ***!
  \**************************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/constants/default-http.const.ts"
/*!*************************************************************!*\
  !*** ./libs/auth-vault/src/constants/default-http.const.ts ***!
  \*************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/constants/enforcer-options.const.ts"
/*!*****************************************************************!*\
  !*** ./libs/auth-vault/src/constants/enforcer-options.const.ts ***!
  \*****************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/constants/index.ts"
/*!************************************************!*\
  !*** ./libs/auth-vault/src/constants/index.ts ***!
  \************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./default-http.const */ "./libs/auth-vault/src/constants/default-http.const.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-guard.const */ "./libs/auth-vault/src/constants/auth-guard.const.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-messages.const */ "./libs/auth-vault/src/constants/auth-messages.const.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-metadata.const */ "./libs/auth-vault/src/constants/auth-metadata.const.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-method-header.const */ "./libs/auth-vault/src/constants/auth-method-header.const.ts"), exports);
__exportStar(__webpack_require__(/*! ./resource-guard.const */ "./libs/auth-vault/src/constants/resource-guard.const.ts"), exports);
__exportStar(__webpack_require__(/*! ./role-guard.const */ "./libs/auth-vault/src/constants/role-guard.const.ts"), exports);
__exportStar(__webpack_require__(/*! ./enforcer-options.const */ "./libs/auth-vault/src/constants/enforcer-options.const.ts"), exports);


/***/ },

/***/ "./libs/auth-vault/src/constants/resource-guard.const.ts"
/*!***************************************************************!*\
  !*** ./libs/auth-vault/src/constants/resource-guard.const.ts ***!
  \***************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/constants/role-guard.const.ts"
/*!***********************************************************!*\
  !*** ./libs/auth-vault/src/constants/role-guard.const.ts ***!
  \***********************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/decorators/access-token.decorator.ts"
/*!******************************************************************!*\
  !*** ./libs/auth-vault/src/decorators/access-token.decorator.ts ***!
  \******************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const utils_1 = __webpack_require__(/*! ../utils */ "./libs/auth-vault/src/utils/index.ts");
...
/***/ "./libs/auth-vault/src/decorators/auth-user.decorator.ts"
/*!***************************************************************!*\
  !*** ./libs/auth-vault/src/decorators/auth-user.decorator.ts ***!
  \***************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/decorators/conditional-scopes.decorator.ts"
/*!************************************************************************!*\
  !*** ./libs/auth-vault/src/decorators/conditional-scopes.decorator.ts ***!
  \************************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/decorators/enforcer-options.decorator.ts"
/*!**********************************************************************!*\
  !*** ./libs/auth-vault/src/decorators/enforcer-options.decorator.ts ***!
  \**********************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/decorators/index.ts"
/*!*************************************************!*\
  !*** ./libs/auth-vault/src/decorators/index.ts ***!
  \*************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./public.decorator */ "./libs/auth-vault/src/decorators/public.decorator.ts"), exports);
__exportStar(__webpack_require__(/*! ./resource.decorator */ "./libs/auth-vault/src/decorators/resource.decorator.ts"), exports);
__exportStar(__webpack_require__(/*! ./scopes.decorator */ "./libs/auth-vault/src/decorators/scopes.decorator.ts"), exports);
__exportStar(__webpack_require__(/*! ./conditional-scopes.decorator */ "./libs/auth-vault/src/decorators/conditional-scopes.decorator.ts"), exports);
__exportStar(__webpack_require__(/*! ./resolved-scopes.decorator */ "./libs/auth-vault/src/decorators/resolved-scopes.decorator.ts"), exports);
__exportStar(__webpack_require__(/*! ./role.decorator */ "./libs/auth-vault/src/decorators/role.decorator.ts"), exports);
__exportStar(__webpack_require__(/*! ./role-match-mode.decorator */ "./libs/auth-vault/src/decorators/role-match-mode.decorator.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-user.decorator */ "./libs/auth-vault/src/decorators/auth-user.decorator.ts"), exports);
__exportStar(__webpack_require__(/*! ./enforcer-options.decorator */ "./libs/auth-vault/src/decorators/enforcer-options.decorator.ts"), exports);
__exportStar(__webpack_require__(/*! ./access-token.decorator */ "./libs/auth-vault/src/decorators/access-token.decorator.ts"), exports);


/***/ },

/***/ "./libs/auth-vault/src/decorators/public.decorator.ts"
/*!************************************************************!*\
  !*** ./libs/auth-vault/src/decorators/public.decorator.ts ***!
  \************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/decorators/resolved-scopes.decorator.ts"
/*!*********************************************************************!*\
  !*** ./libs/auth-vault/src/decorators/resolved-scopes.decorator.ts ***!
  \*********************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/decorators/resource.decorator.ts"
/*!**************************************************************!*\
  !*** ./libs/auth-vault/src/decorators/resource.decorator.ts ***!
  \**************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/decorators/role-match-mode.decorator.ts"
/*!*********************************************************************!*\
  !*** ./libs/auth-vault/src/decorators/role-match-mode.decorator.ts ***!
  \*********************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/decorators/role.decorator.ts"
/*!**********************************************************!*\
  !*** ./libs/auth-vault/src/decorators/role.decorator.ts ***!
  \**********************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/decorators/scopes.decorator.ts"
/*!************************************************************!*\
  !*** ./libs/auth-vault/src/decorators/scopes.decorator.ts ***!
  \************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/dto/index.ts"
/*!******************************************!*\
  !*** ./libs/auth-vault/src/dto/index.ts ***!
  \******************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./login-credentials.dto */ "./libs/auth-vault/src/dto/login-credentials.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./login-error-response.dto */ "./libs/auth-vault/src/dto/login-error-response.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./login-response.dto */ "./libs/auth-vault/src/dto/login-response.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./logout-credentials.dto */ "./libs/auth-vault/src/dto/logout-credentials.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./logout-error-response.dto */ "./libs/auth-vault/src/dto/logout-error-response.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./logout-response.dto */ "./libs/auth-vault/src/dto/logout-response.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./refresh-token-credentials.dto */ "./libs/auth-vault/src/dto/refresh-token-credentials.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./refresh-token-error-response.dto */ "./libs/auth-vault/src/dto/refresh-token-error-response.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./refresh-token-response.dto */ "./libs/auth-vault/src/dto/refresh-token-response.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./token-credentials.dto */ "./libs/auth-vault/src/dto/token-credentials.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./user-info-error-response.dto */ "./libs/auth-vault/src/dto/user-info-error-response.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./user-info-response.dto */ "./libs/auth-vault/src/dto/user-info-response.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./validate-error-response.dto */ "./libs/auth-vault/src/dto/validate-error-response.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./validate-response.dto */ "./libs/auth-vault/src/dto/validate-response.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./realm-access.dto */ "./libs/auth-vault/src/dto/realm-access.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./resource-access.dto */ "./libs/auth-vault/src/dto/resource-access.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./login-response.dto */ "./libs/auth-vault/src/dto/login-response.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./login-credentials.dto */ "./libs/auth-vault/src/dto/login-credentials.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./logout-credentials.dto */ "./libs/auth-vault/src/dto/logout-credentials.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./logout-response.dto */ "./libs/auth-vault/src/dto/logout-response.dto.ts"), exports);
...
/***/ "./libs/auth-vault/src/dto/login-credentials.dto.ts"
/*!**********************************************************!*\
  !*** ./libs/auth-vault/src/dto/login-credentials.dto.ts ***!
  \**********************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/dto/login-error-response.dto.ts"
/*!*************************************************************!*\
  !*** ./libs/auth-vault/src/dto/login-error-response.dto.ts ***!
  \*************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const auth_messages_const_1 = __webpack_require__(/*! ./../constants/auth-messages.const */ "./libs/auth-vault/src/constants/auth-messages.const.ts");
const swagger_1 = __webpack_require__(/*! @nestjs/swagger */ "@nestjs/swagger");
const class_validator_1 = __webpack_require__(/*! class-validator */ "class-validator");
...
/***/ "./libs/auth-vault/src/dto/login-response.dto.ts"
/*!*******************************************************!*\
  !*** ./libs/auth-vault/src/dto/login-response.dto.ts ***!
  \*******************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/dto/logout-credentials.dto.ts"
/*!***********************************************************!*\
  !*** ./libs/auth-vault/src/dto/logout-credentials.dto.ts ***!
  \***********************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/dto/logout-error-response.dto.ts"
/*!**************************************************************!*\
  !*** ./libs/auth-vault/src/dto/logout-error-response.dto.ts ***!
  \**************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/dto/logout-response.dto.ts"
/*!********************************************************!*\
  !*** ./libs/auth-vault/src/dto/logout-response.dto.ts ***!
  \********************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/dto/realm-access.dto.ts"
/*!*****************************************************!*\
  !*** ./libs/auth-vault/src/dto/realm-access.dto.ts ***!
  \*****************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/dto/refresh-token-credentials.dto.ts"
/*!******************************************************************!*\
  !*** ./libs/auth-vault/src/dto/refresh-token-credentials.dto.ts ***!
  \******************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/dto/refresh-token-error-response.dto.ts"
/*!*********************************************************************!*\
  !*** ./libs/auth-vault/src/dto/refresh-token-error-response.dto.ts ***!
  \*********************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/dto/refresh-token-response.dto.ts"
/*!***************************************************************!*\
  !*** ./libs/auth-vault/src/dto/refresh-token-response.dto.ts ***!
  \***************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/dto/resource-access.dto.ts"
/*!********************************************************!*\
  !*** ./libs/auth-vault/src/dto/resource-access.dto.ts ***!
  \********************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/dto/token-credentials.dto.ts"
/*!**********************************************************!*\
  !*** ./libs/auth-vault/src/dto/token-credentials.dto.ts ***!
  \**********************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/dto/user-info-error-response.dto.ts"
/*!*****************************************************************!*\
  !*** ./libs/auth-vault/src/dto/user-info-error-response.dto.ts ***!
  \*****************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/dto/user-info-response.dto.ts"
/*!***********************************************************!*\
  !*** ./libs/auth-vault/src/dto/user-info-response.dto.ts ***!
  \***********************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/dto/validate-error-response.dto.ts"
/*!****************************************************************!*\
  !*** ./libs/auth-vault/src/dto/validate-error-response.dto.ts ***!
  \****************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/dto/validate-response.dto.ts"
/*!**********************************************************!*\
  !*** ./libs/auth-vault/src/dto/validate-response.dto.ts ***!
  \**********************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const swagger_1 = __webpack_require__(/*! @nestjs/swagger */ "@nestjs/swagger");
const class_validator_1 = __webpack_require__(/*! class-validator */ "class-validator");
const dto_1 = __webpack_require__(/*! ../dto */ "./libs/auth-vault/src/dto/index.ts");
...
/***/ "./libs/auth-vault/src/guards/auth.guard.ts"
/*!**************************************************!*\
  !*** ./libs/auth-vault/src/guards/auth.guard.ts ***!
  \**************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const core_1 = __webpack_require__(/*! @nestjs/core */ "@nestjs/core");
const constants_1 = __webpack_require__(/*! ../constants */ "./libs/auth-vault/src/constants/index.ts");
const internal_util_1 = __webpack_require__(/*! ../utils/internal.util */ "./libs/auth-vault/src/utils/internal.util.ts");
const public_decorator_1 = __webpack_require__(/*! ../decorators/public.decorator */ "./libs/auth-vault/src/decorators/public.decorator.ts");
const auth_vault_logger_factory_const_1 = __webpack_require__(/*! ../constants/auth-vault-logger-factory.const */ "./libs/auth-vault/src/constants/auth-vault-logger-factory.const.ts");
const tokens_1 = __webpack_require__(/*! ../tokens */ "./libs/auth-vault/src/tokens/index.ts");
...
/***/ "./libs/auth-vault/src/guards/index.ts"
/*!*********************************************!*\
  !*** ./libs/auth-vault/src/guards/index.ts ***!
  \*********************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./auth.guard */ "./libs/auth-vault/src/guards/auth.guard.ts"), exports);
__exportStar(__webpack_require__(/*! ./resource.guard */ "./libs/auth-vault/src/guards/resource.guard.ts"), exports);
__exportStar(__webpack_require__(/*! ./role.guard */ "./libs/auth-vault/src/guards/role.guard.ts"), exports);


/***/ },

/***/ "./libs/auth-vault/src/guards/resource.guard.ts"
/*!******************************************************!*\
  !*** ./libs/auth-vault/src/guards/resource.guard.ts ***!
  \******************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const constants_1 = __webpack_require__(/*! ../constants */ "./libs/auth-vault/src/constants/index.ts");
const utils_1 = __webpack_require__(/*! ../utils */ "./libs/auth-vault/src/utils/index.ts");
const decorators_1 = __webpack_require__(/*! ../decorators */ "./libs/auth-vault/src/decorators/index.ts");
const auth_vault_logger_factory_const_1 = __webpack_require__(/*! ../constants/auth-vault-logger-factory.const */ "./libs/auth-vault/src/constants/auth-vault-logger-factory.const.ts");
const tokens_1 = __webpack_require__(/*! ../tokens */ "./libs/auth-vault/src/tokens/index.ts");
...
/***/ "./libs/auth-vault/src/guards/role.guard.ts"
/*!**************************************************!*\
  !*** ./libs/auth-vault/src/guards/role.guard.ts ***!
  \**************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const core_1 = __webpack_require__(/*! @nestjs/core */ "@nestjs/core");
const role_guard_const_1 = __webpack_require__(/*! ../constants/role-guard.const */ "./libs/auth-vault/src/constants/role-guard.const.ts");
const constants_1 = __webpack_require__(/*! ../constants */ "./libs/auth-vault/src/constants/index.ts");
const decorators_1 = __webpack_require__(/*! ../decorators */ "./libs/auth-vault/src/decorators/index.ts");
const utils_1 = __webpack_require__(/*! ../utils */ "./libs/auth-vault/src/utils/index.ts");
const auth_vault_logger_factory_const_1 = __webpack_require__(/*! ../constants/auth-vault-logger-factory.const */ "./libs/auth-vault/src/constants/auth-vault-logger-factory.const.ts");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./constants */ "./libs/auth-vault/src/constants/index.ts"), exports);
__exportStar(__webpack_require__(/*! ./decorators */ "./libs/auth-vault/src/decorators/index.ts"), exports);
__exportStar(__webpack_require__(/*! ./dto */ "./libs/auth-vault/src/dto/index.ts"), exports);
__exportStar(__webpack_require__(/*! ./guards */ "./libs/auth-vault/src/guards/index.ts"), exports);
__exportStar(__webpack_require__(/*! ./interfaces */ "./libs/auth-vault/src/interfaces/index.ts"), exports);
__exportStar(__webpack_require__(/*! ./types */ "./libs/auth-vault/src/types/index.ts"), exports);
__exportStar(__webpack_require__(/*! ./tokens */ "./libs/auth-vault/src/tokens/index.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-vault.module */ "./libs/auth-vault/src/auth-vault.module.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-vault.service */ "./libs/auth-vault/src/auth-vault.service.ts"), exports);


/***/ },

/***/ "./libs/auth-vault/src/interfaces/auth-request.interface.ts"
/*!******************************************************************!*\
  !*** ./libs/auth-vault/src/interfaces/auth-request.interface.ts ***!
  \******************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/interfaces/auth-strategy.interface.ts"
/*!*******************************************************************!*\
  !*** ./libs/auth-vault/src/interfaces/auth-strategy.interface.ts ***!
  \*******************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/interfaces/auth-vault-library-options.interface.ts"
/*!********************************************************************************!*\
  !*** ./libs/auth-vault/src/interfaces/auth-vault-library-options.interface.ts ***!
  \********************************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/interfaces/auth-vault-module-options.interface.ts"
/*!*******************************************************************************!*\
  !*** ./libs/auth-vault/src/interfaces/auth-vault-module-options.interface.ts ***!
  \*******************************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/interfaces/auth-vault-service.interface.ts"
/*!************************************************************************!*\
  !*** ./libs/auth-vault/src/interfaces/auth-vault-service.interface.ts ***!
  \************************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/interfaces/auth-vault.logger.interface.ts"
/*!***********************************************************************!*\
  !*** ./libs/auth-vault/src/interfaces/auth-vault.logger.interface.ts ***!
  \***********************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/interfaces/enforcer-options.interface.ts"
/*!**********************************************************************!*\
  !*** ./libs/auth-vault/src/interfaces/enforcer-options.interface.ts ***!
  \**********************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/interfaces/index.ts"
/*!*************************************************!*\
  !*** ./libs/auth-vault/src/interfaces/index.ts ***!
  \*************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./auth-request.interface */ "./libs/auth-vault/src/interfaces/auth-request.interface.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-strategy.interface */ "./libs/auth-vault/src/interfaces/auth-strategy.interface.ts"), exports);
__exportStar(__webpack_require__(/*! ./resource-guard-options.interface */ "./libs/auth-vault/src/interfaces/resource-guard-options.interface.ts"), exports);
__exportStar(__webpack_require__(/*! ./role-guard-options.interface */ "./libs/auth-vault/src/interfaces/role-guard-options.interface.ts"), exports);
__exportStar(__webpack_require__(/*! ./enforcer-options.interface */ "./libs/auth-vault/src/interfaces/enforcer-options.interface.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-vault-module-options.interface */ "./libs/auth-vault/src/interfaces/auth-vault-module-options.interface.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-vault-library-options.interface */ "./libs/auth-vault/src/interfaces/auth-vault-library-options.interface.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-vault.logger.interface */ "./libs/auth-vault/src/interfaces/auth-vault.logger.interface.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-vault-service.interface */ "./libs/auth-vault/src/interfaces/auth-vault-service.interface.ts"), exports);


/***/ },

/***/ "./libs/auth-vault/src/interfaces/resource-guard-options.interface.ts"
/*!****************************************************************************!*\
  !*** ./libs/auth-vault/src/interfaces/resource-guard-options.interface.ts ***!
  \****************************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/interfaces/role-guard-options.interface.ts"
/*!************************************************************************!*\
  !*** ./libs/auth-vault/src/interfaces/role-guard-options.interface.ts ***!
  \************************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/logger/auth-vault.logger.ts"
/*!*********************************************************!*\
  !*** ./libs/auth-vault/src/logger/auth-vault.logger.ts ***!
  \*********************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const interfaces_1 = __webpack_require__(/*! ../interfaces */ "./libs/auth-vault/src/interfaces/index.ts");
const log_levels_validator_1 = __webpack_require__(/*! ../utils/log-levels.validator */ "./libs/auth-vault/src/utils/log-levels.validator.ts");
...
/***/ "./libs/auth-vault/src/strategies/auth-strategy.abstract.ts"
/*!******************************************************************!*\
  !*** ./libs/auth-vault/src/strategies/auth-strategy.abstract.ts ***!
  \******************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const auth_method_header_const_1 = __webpack_require__(/*! ./../constants/auth-method-header.const */ "./libs/auth-vault/src/constants/auth-method-header.const.ts");
const class_validator_1 = __webpack_require__(/*! class-validator */ "class-validator");
const class_transformer_1 = __webpack_require__(/*! class-transformer */ "class-transformer");
const rxjs_1 = __webpack_require__(/*! rxjs */ "rxjs");
const types_1 = __webpack_require__(/*! ../types */ "./libs/auth-vault/src/types/index.ts");
...
/***/ "./libs/auth-vault/src/strategies/keycloak/dto/keycloak-config.dto.ts"
/*!****************************************************************************!*\
  !*** ./libs/auth-vault/src/strategies/keycloak/dto/keycloak-config.dto.ts ***!
  \****************************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/strategies/keycloak/keycloak.strategy.ts"
/*!**********************************************************************!*\
  !*** ./libs/auth-vault/src/strategies/keycloak/keycloak.strategy.ts ***!
  \**********************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const auth_strategy_abstract_1 = __webpack_require__(/*! ../auth-strategy.abstract */ "./libs/auth-vault/src/strategies/auth-strategy.abstract.ts");
const keycloak_url_builder_1 = __webpack_require__(/*! ./services/keycloak-url.builder */ "./libs/auth-vault/src/strategies/keycloak/services/keycloak-url.builder.ts");
const axios_1 = __webpack_require__(/*! @nestjs/axios */ "@nestjs/axios");
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const auth_keycloak_mapper_1 = __webpack_require__(/*! ./mappers/auth-keycloak.mapper */ "./libs/auth-vault/src/strategies/keycloak/mappers/auth-keycloak.mapper.ts");
const auth_messages_const_1 = __webpack_require__(/*! ../../constants/auth-messages.const */ "./libs/auth-vault/src/constants/auth-messages.const.ts");
const tokens_1 = __webpack_require__(/*! ../../tokens */ "./libs/auth-vault/src/tokens/index.ts");
const auth_vault_logger_factory_const_1 = __webpack_require__(/*! ../../constants/auth-vault-logger-factory.const */ "./libs/auth-vault/src/constants/auth-vault-logger-factory.const.ts");
...
/***/ "./libs/auth-vault/src/strategies/keycloak/mappers/auth-keycloak.mapper.ts"
/*!*********************************************************************************!*\
  !*** ./libs/auth-vault/src/strategies/keycloak/mappers/auth-keycloak.mapper.ts ***!
  \*********************************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/strategies/keycloak/services/keycloak-url.builder.ts"
/*!**********************************************************************************!*\
  !*** ./libs/auth-vault/src/strategies/keycloak/services/keycloak-url.builder.ts ***!
  \**********************************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/strategies/strategies.registry.ts"
/*!***************************************************************!*\
  !*** ./libs/auth-vault/src/strategies/strategies.registry.ts ***!
  \***************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const keycloak_strategy_1 = __webpack_require__(/*! ./keycloak/keycloak.strategy */ "./libs/auth-vault/src/strategies/keycloak/keycloak.strategy.ts");
...
/***/ "./libs/auth-vault/src/tokens/auth-strategies.token.ts"
/*!*************************************************************!*\
  !*** ./libs/auth-vault/src/tokens/auth-strategies.token.ts ***!
  \*************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/tokens/auth-strategy-config.token.ts"
/*!******************************************************************!*\
  !*** ./libs/auth-vault/src/tokens/auth-strategy-config.token.ts ***!
  \******************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/tokens/auth-vault-options.token.ts"
/*!****************************************************************!*\
  !*** ./libs/auth-vault/src/tokens/auth-vault-options.token.ts ***!
  \****************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/tokens/auth-vault-service.token.ts"
/*!****************************************************************!*\
  !*** ./libs/auth-vault/src/tokens/auth-vault-service.token.ts ***!
  \****************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/tokens/index.ts"
/*!*********************************************!*\
  !*** ./libs/auth-vault/src/tokens/index.ts ***!
  \*********************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./auth-strategies.token */ "./libs/auth-vault/src/tokens/auth-strategies.token.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-vault-options.token */ "./libs/auth-vault/src/tokens/auth-vault-options.token.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-strategy-config.token */ "./libs/auth-vault/src/tokens/auth-strategy-config.token.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-vault-service.token */ "./libs/auth-vault/src/tokens/auth-vault-service.token.ts"), exports);


/***/ },

/***/ "./libs/auth-vault/src/types/auth-vault-module-async-options.type.ts"
/*!***************************************************************************!*\
  !*** ./libs/auth-vault/src/types/auth-vault-module-async-options.type.ts ***!
  \***************************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/types/auth-vault-options.type.ts"
/*!**************************************************************!*\
  !*** ./libs/auth-vault/src/types/auth-vault-options.type.ts ***!
  \**************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/types/conditional-scope-fn.type.ts"
/*!****************************************************************!*\
  !*** ./libs/auth-vault/src/types/conditional-scope-fn.type.ts ***!
  \****************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/types/index.ts"
/*!********************************************!*\
  !*** ./libs/auth-vault/src/types/index.ts ***!
  \********************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./login-response.type */ "./libs/auth-vault/src/types/login-response.type.ts"), exports);
__exportStar(__webpack_require__(/*! ./logout-response.type */ "./libs/auth-vault/src/types/logout-response.type.ts"), exports);
__exportStar(__webpack_require__(/*! ./refresh-token-response.type */ "./libs/auth-vault/src/types/refresh-token-response.type.ts"), exports);
__exportStar(__webpack_require__(/*! ./user-info-response.type */ "./libs/auth-vault/src/types/user-info-response.type.ts"), exports);
__exportStar(__webpack_require__(/*! ./validate-response.type */ "./libs/auth-vault/src/types/validate-response.type.ts"), exports);
__exportStar(__webpack_require__(/*! ./conditional-scope-fn.type */ "./libs/auth-vault/src/types/conditional-scope-fn.type.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-vault-module-async-options.type */ "./libs/auth-vault/src/types/auth-vault-module-async-options.type.ts"), exports);
__exportStar(__webpack_require__(/*! ./auth-vault-options.type */ "./libs/auth-vault/src/types/auth-vault-options.type.ts"), exports);
__exportStar(__webpack_require__(/*! ./strategy-config-dto.types */ "./libs/auth-vault/src/types/strategy-config-dto.types.ts"), exports);


/***/ },

/***/ "./libs/auth-vault/src/types/login-response.type.ts"
/*!**********************************************************!*\
  !*** ./libs/auth-vault/src/types/login-response.type.ts ***!
  \**********************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/types/logout-response.type.ts"
/*!***********************************************************!*\
  !*** ./libs/auth-vault/src/types/logout-response.type.ts ***!
  \***********************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/types/refresh-token-response.type.ts"
/*!******************************************************************!*\
  !*** ./libs/auth-vault/src/types/refresh-token-response.type.ts ***!
  \******************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/types/strategy-config-dto.types.ts"
/*!****************************************************************!*\
  !*** ./libs/auth-vault/src/types/strategy-config-dto.types.ts ***!
  \****************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const keycloak_config_dto_1 = __webpack_require__(/*! ../strategies/keycloak/dto/keycloak-config.dto */ "./libs/auth-vault/src/strategies/keycloak/dto/keycloak-config.dto.ts");
...
/***/ "./libs/auth-vault/src/types/user-info-response.type.ts"
/*!**************************************************************!*\
  !*** ./libs/auth-vault/src/types/user-info-response.type.ts ***!
  \**************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/types/validate-response.type.ts"
/*!*************************************************************!*\
  !*** ./libs/auth-vault/src/types/validate-response.type.ts ***!
  \*************************************************************/
(__unused_webpack_module, exports) {
...
/***/ "./libs/auth-vault/src/utils/index.ts"
/*!********************************************!*\
  !*** ./libs/auth-vault/src/utils/index.ts ***!
  \********************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./internal.util */ "./libs/auth-vault/src/utils/internal.util.ts"), exports);
__exportStar(__webpack_require__(/*! ./log-levels.validator */ "./libs/auth-vault/src/utils/log-levels.validator.ts"), exports);


/***/ },

/***/ "./libs/auth-vault/src/utils/internal.util.ts"
/*!****************************************************!*\
  !*** ./libs/auth-vault/src/utils/internal.util.ts ***!
  \****************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./libs/auth-vault/src/utils/log-levels.validator.ts"
/*!***********************************************************!*\
  !*** ./libs/auth-vault/src/utils/log-levels.validator.ts ***!
  \***********************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const swagger_module_1 = __webpack_require__(/*! ./swagger/swagger.module */ "./src/swagger/swagger.module.ts");
const config_1 = __webpack_require__(/*! @nestjs/config */ "@nestjs/config");
const keycloak_module_1 = __webpack_require__(/*! ./modules/keycloak/keycloak.module */ "./src/modules/keycloak/keycloak.module.ts");
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const swagger_service_1 = __webpack_require__(/*! ./swagger/swagger.service */ "./src/swagger/swagger.service.ts");
async function app() {
    ...
    const swaggerService = nestApp.get(swagger_service_1.SwaggerService);
...
/***/ "./src/modules/keycloak/keycloak.controller.ts"
/*!*****************************************************!*\
  !*** ./src/modules/keycloak/keycloak.controller.ts ***!
  \*****************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const auth_vault_1 = __webpack_require__(/*! @app/auth-vault */ "./libs/auth-vault/src/index.ts");
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
let KeycloakController = class KeycloakController {
    authVaultService;
    constructor(authVaultService) {
        this.authVaultService = authVaultService;
    }
    async login(body) {
...
__decorate([
    ...
    (0, auth_vault_1.Public)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof auth_vault_1.LoginCredentialsDto !== "undefined" && auth_vault_1.LoginCredentialsDto) === "function" ? _b : Object]),
    __metadata("design:returntype", Promise)
], KeycloakController.prototype, "login", null);
__decorate([
    (0, common_1.Get)('user-info'),
    __param(0, (0, auth_vault_1.AuthUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], KeycloakController.prototype, "userInfo", null);
exports.KeycloakController = KeycloakController = __decorate([
    (0, common_1.Controller)('keycloak'),
    __metadata("design:paramtypes", [typeof (_a = typeof auth_vault_1.AuthVaultService !== "undefined" && auth_vault_1.AuthVaultService) === "function" ? _a : Object])
], KeycloakController);


/***/ },

/***/ "./src/modules/keycloak/keycloak.module.ts"
/*!*************************************************!*\
  !*** ./src/modules/keycloak/keycloak.module.ts ***!
  \*************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const config_1 = __webpack_require__(/*! @nestjs/config */ "@nestjs/config");
const keycloak_controller_1 = __webpack_require__(/*! ./keycloak.controller */ "./src/modules/keycloak/keycloak.controller.ts");
...
exports.KeycloakModule = KeycloakModule = __decorate([
    (0, common_1.Module)({
        imports: [
            auth_vault_1.AuthVaultModule.forFeatureAsync({
                useFactory: (configService) => ({
                    logLevels: [auth_vault_1.AuthLogLevel.ERROR, auth_vault_1.AuthLogLevel.WARN, auth_vault_1.AuthLogLevel.LOG],
                    strategyConfig: {
                        name: 'keycloak',
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const swagger_service_1 = __webpack_require__(/*! ./swagger.service */ "./src/swagger/swagger.service.ts");
...
let SwaggerService = class SwaggerService {
    ...
    setupSwagger(app) {
        const options = new swagger_1.DocumentBuilder()
            .setTitle(this.configService.get('npm_package_name', 'Orchestron Core API'))
            .setDescription(this.configService.get('npm_package_description', 'Orchestron Core API Documentation'))
            .setVersion(this.configService.get('npm_package_version', '0.0.0'))
            .addBearerAuth()
        ...
        const document = swagger_1.SwaggerModule.createDocument(app, options, documentOptions);
        const pathSwagger = this.configService.get('PATH_SWAGGER', 'swagger');
        swagger_1.SwaggerModule.setup(pathSwagger, app, document, {
            swaggerOptions: {
                filter: true,
            },
        });
...
const os_1 = __webpack_require__(/*! os */ "os");
const config_1 = __webpack_require__(/*! @nestjs/config */ "@nestjs/config");
const index_util_1 = __webpack_require__(/*! ./utils/index.util */ "./src/utils/index.util.ts");
const app_1 = __webpack_require__(/*! ./app */ "./src/app.ts");
function formatUrl(schema, host, port) {
    return `${schema}://${host}:${port}`;
}
async function bootstrap() {
    const application = await (0, app_1.app)();
    const configService = application.get(config_1.ConfigService);
    const port = configService.get('PORT', 3000);
    const environment = configService.get('NODE_ENV', 'development');
    application.enableShutdownHooks();
    await application.listen(port, '0.0.0.0');
    const networks = (0, index_util_1.getNetworkInterfaces)();
    const internalIps = networks.filter((net) => net.internal);
    const externalIps = networks.filter((net) => !net.internal);
    console.log('\n');
    ...
    console.log(`   Hostname:    \x1b[33m${(0, os_1.hostname)()}\x1b[0m`);
    ...
    if (externalIps.length > 0) {
        ...
        console.log('\n\x1b[33m%s\x1b[0m', '⚠️  No external network interfaces found');
    }
    console.log('\n\x1b[36m%s\x1b[0m', '═══════════════════════════════════════════════════════════\n');
}
void bootstrap();
